...
-- Sn Transaction Details  procedure call
   ...
   END;
    ...
    IF l_card_stat = '2' AND l_txn_code_in <> '06' AND l_txn_code_in <> '74'  THEN
     p_resp_code_out := '41';
     l_errmsg        := 'Lost Card';
     RAISE EXP_REJECT_RECORD;
    END IF;
    ...
    IF (l_txn_code_in = '05' OR l_txn_code_in = '73') AND l_card_stat = '0'   THEN
     p_resp_code_out := '10';
...
BEGIN
      ...
      END IF;
		...
		BEGIN
		   ...
		   IF P_TXN_CODE_IN = '09' AND  L_ACTIVE_DATE IS NULL AND L_DEFUND_FLAG = 'Y' AND L_ACCT_BAL = 0 AND L_PARAM_VALUE = 'N'
		   THEN

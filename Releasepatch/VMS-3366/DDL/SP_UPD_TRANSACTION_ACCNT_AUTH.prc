...
BEGIN
  ...
  /*  BEGIN
    ...
    IF V_CRACCT_NO = P_CARD_ACCT_NO THEN
      ...
      ELSIF ((P_DELIVERY_CHANNEL = '08' AND P_TXN_CODE = '26')  OR (P_DELIVERY_CHANNEL = '04' AND P_TXN_CODE  IN ('68' ,'91') )) THEN -- Initial Load amount updation.
...
WHEN OTHERS THEN
  ...
  --En check any fees attached if so credit or debit the acct
    ...
    IF P_DELIVERY_CHANNEL||P_TXN_CODE IN ('0481','0491') 
    	AND NVL(P_MSG,'1200') NOT IN ('0400','1400')

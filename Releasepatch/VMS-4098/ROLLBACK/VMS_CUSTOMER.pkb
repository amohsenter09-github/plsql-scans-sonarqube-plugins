        ...
        p_resp_msg_out :='success';
         ...
         BEGIN
            SELECT pan.cap_pan_code, pan.cap_pan_code_encr, pan.cap_acct_no,
                   ...
                   cust.ccm_cust_code, decode(cattype.cpc_encrypt_enable,'Y',fn_dmaps_main(cust.ccm_first_name),cust.ccm_first_name)
              INTO l_hash_pan, l_encr_pan, p_spend_acct_no_out,
                   ...
                   l_cust_code, p_name_on_card_out
    ...
    END IF;
     ...
     BEGIN
      ...
      SELECT  TRIM(TO_CHAR (cam_acct_bal, '99999999999999990.99')),
                   TRIM(TO_CHAR (cam_ledger_bal, '99999999999999990.99')),
                   TRIM(TO_CHAR (cam_initialload_amt, '99999999999999990.99')),CAM_TYPE_CODE
          INTO   p_spend_avail_bal_out, p_spend_ledger_bal_out,p_initial_load_out,l_acct_type
          FROM   CMS_ACCT_MAST
...
-- Sn Transaction Details  procedure call
   ...
   BEGIN
    ...
    -- SN Generate ADDRESS select query
         BEGIN
            l_addr_select_query :=
                              '(SELECT (CASE cam_addr_flag
                                        ...
                                        ELSE
                                           ''MAILING''
                                        END) address_type,
                                  decode(:l_encrypt_enable,''Y'',fn_dmaps_main(cam_add_one),cam_add_one) address1,
                                  decode(:l_encrypt_enable,''Y'',fn_dmaps_main(cam_add_two),cam_add_two) address2,
                                  decode(:l_encrypt_enable,''Y'',fn_dmaps_main(cam_city_name),cam_city_name) city,
                                  (SELECT upper(gs.gsm_switch_state_code)
                                   ...
                                   decode(:l_encrypt_enable,''Y'', fn_dmaps_main(cam_pin_code),cam_pin_code) zip,
                                  (SELECT upper(gcm.gcm_switch_cntry_code)
   ...
   -- SN Open cursor to execute address select query
         BEGIN
           OPEN p_address_out FOR l_addr_select_query
           USING l_encrypt_enable,l_encrypt_enable,l_encrypt_enable,l_encrypt_enable,
    ...
    p_resp_msg_out := 'success';
      ...
      END;
       ...
       BEGIN
           ...
           FROM CMS_CUST_MAST
           WHERE CCM_CUST_ID= p_cust_id_in AND CCM_INST_CODE=p_inst_code_in ;
     ...
     BEGIN
        ...
        UPDATE CMS_CUST_MAST
         ...
         WHERE CCM_INST_CODE=p_inst_code_in AND CCM_CUST_ID=p_cust_id_in;
     ...
     BEGIN
         ...
         VALUES(p_inst_code_in,p_cust_id_in,trim(p_secquest1_in),l_hash_sqa1);

         INSERT INTO cms_security_questions(csq_inst_code,csq_cust_id,csq_question,csq_answer_hash)
         VALUES(p_inst_code_in,p_cust_id_in,trim(p_secquest2_in),l_hash_sqa2);

         INSERT INTO cms_security_questions(csq_inst_code,csq_cust_id,csq_question,csq_answer_hash)
         VALUES(p_inst_code_in,p_cust_id_in,trim(p_secquest3_in),l_hash_sqa3);
...
IF p_msg_type_in ='0200' THEN
 ...
 BEGIN
  ...
  if  p_orgRRN_in IS NOT NULL and p_msg_type_in ='0400' and  p_resp_code_out='00' then
      ...
      BEGIN
            update TRANSACTIONLOG set TRAN_REVERSE_FLAG='Y'

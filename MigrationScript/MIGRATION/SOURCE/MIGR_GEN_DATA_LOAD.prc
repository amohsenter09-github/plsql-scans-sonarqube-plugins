...
-----------------------------------------------Sn Account Data Migration-----------------------------------------------------
   ...
   BEGIN
      EXECUTE IMMEDIATE v_sql_statement;       ---Truncate account data files
   EXCEPTION
      WHEN OTHERS
      THEN
         prm_errmsg :=
   ...
   BEGIN
      EXECUTE IMMEDIATE v_sql_statement;      ---Truncate customer data files
   EXCEPTION
      WHEN OTHERS
      THEN
         prm_errmsg :=
...
--------------------------------------------------------En Transaction log Data Migration------------------------------------------------
   BEGIN
      EXECUTE IMMEDIATE v_sql_statement; ---Truncate table to clean all files
   EXCEPTION
      WHEN OTHERS
      THEN
         prm_errmsg :=

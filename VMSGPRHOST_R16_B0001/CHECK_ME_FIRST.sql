...
BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('PLEASE EXECUTE RELEASE VMSGPRHOST_R16_B0001');
        ...
        DBMS_OUTPUT.PUT_LINE(' RELEASE VMSGPRHOST_R16_B0001 IS ALREADY INSTALLED') ;

	    DBMS_OUTPUT.PUT_LINE('****************************************');					
        
        ELSIF V_CIV_VERS_BULD NOT IN ('VMSGPRHOST_R16_B0000','VMSGPRHOST_R16_B0001')
        THEN

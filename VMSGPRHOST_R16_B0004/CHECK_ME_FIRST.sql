...
BEGIN
        ...
        IF V_CIV_VERS_BULD = 'VMSGPRHOST_R16_B0003' 
        THEN 
            
	    DBMS_OUTPUT.PUT_LINE('****************************************');								
			
        DBMS_OUTPUT.PUT_LINE('PLEASE EXECUTE RELEASE VMSGPRHOST_R16_B0004');
        ...
        DBMS_OUTPUT.PUT_LINE(' RELEASE VMSGPRHOST_R16_B0004 IS ALREADY INSTALLED') ;

	    DBMS_OUTPUT.PUT_LINE('****************************************');					
        
        ELSIF V_CIV_VERS_BULD NOT IN ('VMSGPRHOST_R16_B0003','VMSGPRHOST_R16_B0004')
        THEN

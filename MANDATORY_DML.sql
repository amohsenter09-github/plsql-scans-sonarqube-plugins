...
INSERT INTO VMSCMS.CMS_INCOMM_VERSION
    VALUES ('DB - 3.5.1', NULL, 'VMSGPRHOST_R16',SYSDATE,'DBA', SYSDATE);

	
INSERT INTO VMSCMS.CMS_INCOMM_version
    VALUES ('CMS - 3.5.1', NULL, 'VMSGPRHOST_R16',SYSDATE, 'ADMIN', SYSDATE);


INSERT INTO VMSCMS.CMS_INCOMM_version
    VALUES ('JAVA - 3.5.1', NULL, 'VMSGPRHOST_R16',SYSDATE, 'ADMIN', SYSDATE);
...
INSERT INTO vmscms.CMS_INCOMM_VERSION
	VALUES ('CSR-JAVA - 1.0.1', NULL, 'VMSGPRHOST_R16',SYSDATE,'ADMIN', SYSDATE);

INSERT INTO vmscms.CMS_INCOMM_version
    VALUES ('CSR - 1.0.1', NULL, 'VMSGPRHOST_R16',SYSDATE, 'ADMIN', SYSDATE);

create or replace PROCEDURE        vmscms.sp_chw_order_replace_r305 (
...
IS
    ...
    * Modified For         : Update activity 30.5
    * Reviewer             : Pankaj Salunkhe
    * Reviewed Date        : 29-Sep-2015
...
BEGIN
   ...
   BEGIN
      SELECT cap_prod_catg,
             ...
             cap_form_factor  --Added for VMS-846(Replacement Not Allowed for Digital Card)
        INTO v_cap_prod_catg,
             ...
             v_prod_cattype,
             v_card_expdate,
             v_form_factor --Added for VMS-846(Replacement Not Allowed for Digital Card)
        FROM cms_appl_pan
  ...
  END IF; 
   ELSE
      ...
      BEGIN
         sp_order_reissuepan_cms_r305 (p_inst_code,
                                       p_card_no,
                                       v_prod_code,
                                       v_prod_cattype,
                                       new_dispname,

...
AS
  ...
  ****************************************************************************/
  ...
  v_card_dtl                        cms_caf_info_entry.cci_ssnfail_dtls%type;
  ...
  v_fee_planid                PLS_INTEGER; --Added for MVCSD-5381(Review Comments)
      ...
      IF (p_delivery_channel = '08' or v_minorcard)    THEN     --Added for MVCSD-5381
        ...
        SET cci_inst_code         = p_inst_code,
          ...
          CCI_STARTER_CARD_NO_ENCR = v_encr_pan,            --Added for Mantis id -13713
		      CCI_SEG12_NAME_LINE1_ENCR= fn_emaps_main(p_firstname),
